...
const CampaignDetails = () => {
  ...
  const remaniningDays = daysLeft(state.deadline);
  ...
  // which is the second argument to useEffect. 
  //It specifies the dependencies that the effect relies on. 
  // The effect will run whenever any of these dependencies change.
      ...
      <div className="w-full flex md:flex-row flex-col mt-10 gap-[30px]">
        <div className="flex-1 flex-col">
          ...
          <div className="relative w-full h-[5px] bg-[#3a3a43] mt-2">
            ...
            <div className="absolute h-full bg-[#4ac8d]"
        ...
        <div className="flex md:w-[150px] w-full flex-wrap justify-between gap-[30px]">
          <CountBox title = "Days Left" value = {remaniningDays} />
      ...
      <div className="mt-[60px] flex lg:flex-row flex-col gap-5">
        ...
        <div className="flex-1">
          ...
          <div className="mt-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-[10px]">
               ...
               text-center text-[#808191]">Fund the campaign
               </p>
